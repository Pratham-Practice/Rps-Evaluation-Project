package com.example.Movierservice.fisMovieService.model;
...
public class Movies {
	...
	public Movies(int movie_id, String movie_name, int release_year, String language, double rating, String movie_type,
